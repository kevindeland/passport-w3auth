...
BlueAuth.prototype = {
		...
		buildAuth : function(config, getPerson, callback) {
		...
		auth : function(req, res, next) {
			...
			var superuser = this.admin;
			
			console.log(admin);
			console.log(superuser);
			
			this.getPerson(user.name, user.pass, this.getPersonCallback);

		},
		
		getPersonCallback : function(err, person) {
			if(err) {
				console.log('failed login');
				return unauthorized(res);
			}
